...
class AboutInterface(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self.aboutTitle = LargeTitleLabel("SmartLinker")
        ...
        self.updateSnackInstall = PrimaryPushButton(segFont.fromName("OpenIn"), "Install now")
...
class ResourcesGroup(ExpandGroupSettingCard):
    ...
    def __init__(self, parent = None):
        ...
        self.pyQtBtn = ToolButton(QIcon(smart.resourcePath("resources/icons/ico/pyqt6_icon.ico")))
        ...
        self.pyQtBtn2 = ToolButton(QIcon(smart.resourcePath("resources/icons/ico/qtforpython_icon.ico")))
        ...
        self.qFluentBtn = ToolButton(QIcon(smart.resourcePath("resources/icons/ico/qfluentwidgets_icon.ico")))
        ...
        self.flaticonBtn = ToolButton(QIcon(smart.resourcePath("resources/icons/ico/flaticon_icon.ico")))
